package com.yueding.travelweather.service;
...
import com.yueding.travelweather.WeatherActivity;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int alarmHour = 6 * 60 * 60 * 1000;
        Long triggerAtTime = SystemClock.elapsedRealtime() + alarmHour;
